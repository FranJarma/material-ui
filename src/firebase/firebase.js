...
class Firebase {
  ...
  async registrarReserva(
    ...
    cuitEstacionamiento,
    provinciaEstacionamiento,
    ciudadEstacionamiento,
  ...
  async registrarEstacionamiento(
    nombreCompleto,
    nSucursal,
    ubicacion,
    telefono,
  ...
  async modificarEstacionamiento(
    id,
    nombreCompleto,
    nSucursal,
    ubicacion,
  ...
  async modificarHorarios(
    id,
    horaAperturaLunes,
    horaAperturaMartes,
    horaAperturaMiercoles,
    horaAperturaJueves,
    horaAperturaViernes,
    horaAperturaSabado,
    horaAperturaDomingo,
  ...
  //metodo para modificar datos del estacionamiento por id (encargado)
  async modificarMiEstacionamiento(
    id,
    nombreCompleto,
    telefono,
    cuit,
      ...
      .then((doc) => {
        ...
        const nuevaValoracion =
          puntuaciones
            ...
            .reduce((prev, next) => prev + next) / puntuaciones.length;
        this.db.collection("estacionamientos").doc(id).update({
