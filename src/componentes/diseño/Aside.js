...
const Aside = () => {
  ...
  const [subMenuMiEstacionamiento, abrirSubMenuMiEstacionamiento] =
    useState(false);
        ...
        {localStorage.getItem("esEncargado") === "true" ? (
          <>
              ...
              <List disablePadding>
                ...
                <Link to={"/nuevo-cobro"} className={classes.titulosMenu}>
                  <ListItem button className={classes.subMenu}>
                    ...
                    <ListItemText>Ingresar cobro de reservas</ListItemText>
                  </ListItem>
                </Link>
              </List>
            </Collapse>
            <ListItem button onClick={handleClickAbrirSubMenuMiEstacionamiento}>
              ...
              <ListItemText primary="Mi estacionamiento"></ListItemText>
              {subMenuMiEstacionamiento ? (
                <ExpandLessIcon />
              ) : (
                <ExpandMoreIcon />
              )}
            ...
            <Collapse
              in={subMenuMiEstacionamiento}
              timeout="auto"
              unmountOnExit
            >
              <List disablePadding>
                <Link
                  to={"/mi-estacionamiento"}
                  className={classes.titulosMenu}
                >
                  <ListItem button className={classes.subMenu}>
                    <ListItemIcon>
                    ...
                    <ListItemText>Datos del estacionamiento</ListItemText>
                  </ListItem>
                </Link>
                <Link to={"/lugares"} className={classes.titulosMenu}>
                  <ListItem button className={classes.subMenu}>
                    ...
                    <ListItemText>Administrar lugares</ListItemText>
                  </ListItem>
                </Link>
                <Link to={"/horarios-y-dias"} className={classes.titulosMenu}>
                  <ListItem button className={classes.subMenu}>
                    ...
                    <ListItemText>Horarios y días de apertura</ListItemText>
                  </ListItem>
                </Link>
              </List>
            </Collapse>
            <Link to={"/mensualidades"} className={classes.titulosMenu}>
              <ListItem button>
                ...
                <ListItemText>Mensualidades</ListItemText>
              </ListItem>
            </Link>
        ...
        <List>
          <Link to={"/usuarios"} className={classes.titulosMenu}>
            <ListItem button>
              ...
              <ListItemText primary="Administración de usuarios"></ListItemText>
            </ListItem>
          </Link>
          <Link to={"/estacionamientos"} className={classes.titulosMenu}>
            <ListItem button>
              ...
              <ListItemText primary="Administración de playas de estacionamiento"></ListItemText>
            </ListItem>
          </Link>
        </List>
      ) : (
