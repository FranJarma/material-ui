  ...
  const infoCarta = [
    {
      ...
      tareas: [
        {
          descripcion:
            "Gestionar las reservas del día y todas las que se realizaron con anterioridad. Puede cambiar fechas de reservas e ingresar pagos de las mismas.",
          icono: <TodayIcon />,
        },
        {
          descripcion:
            "Gestionar la información de tu estacionamiento, con ubicación georeferenciada. Puedes administrar cada uno de los lugares de tu estacionamiento, tarifas y horarios de apertura.",
          icono: <StoreMallDirectoryIcon />,
        },
        {
          descripcion:
            "Llevar un seguimiento de tu estacionamiento, ingresos mensuales y anuales para poder ayudar a la toma de decisiones.",
          icono: <EqualizerIcon />,
        },
      ],
      imagen: encargado,
    },
    {
      ...
      tareas: [
        {
          descripcion:
            "Buscar todas las playas de estacionamiento registradas según su valoración, ubicación más cercana, etc",
          icono: <NotListedLocationIcon />,
        },
        {
          descripcion:
            "Realizar la reserva en la playa que más le convenga y generar un ticket para presentar como comprobante de la misma.",
          icono: <ConfirmationNumberIcon />,
        },
        {
          descripcion:
            "Realizar el pago correspondiente totalmente de forma virtual con tarjeta de crédito, débito o también puede elegir pagar con efectivo en el establecimiento. Todo esto sin necesidad de moverse de donde está.",
  ...
  return (
    <>
      ...
      <Typography className={classes.titulo}>
        ¿Necesita lugar para estacionar?
      </Typography>
      <p className={classes.subtitulo}>
        Parking app es un sistema web a medida para la reserva y gestión de
        playas de estacionamiento ubicadas en diferentes partes de Argentina.
        Usted podrá acceder a la información de dichas playas, asimismo podrá
        realizar la reserva del lugar que más le guste.
      </p>
                  ...
                  <List>
                    <ListItem className={classes.descripcionCarta}>
                      <ListItemIcon className={classes.icono}>
                        {carta.tareas[0].icono}
                      </ListItemIcon>
                      {carta.tareas[0].descripcion}
                    </ListItem>
                    <ListItem className={classes.descripcionCarta}>
                      <ListItemIcon className={classes.icono}>
                        {carta.tareas[1].icono}
                      </ListItemIcon>
                      {carta.tareas[1].descripcion}
                    </ListItem>
                    <ListItem className={classes.descripcionCarta}>
                      <ListItemIcon className={classes.icono}>
                        {carta.tareas[2].icono}
                      </ListItemIcon>
