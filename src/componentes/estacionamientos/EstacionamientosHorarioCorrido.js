...
const EstacionamientosHorarioCorrido = () => {
   ...
   function manejarSnapshot(snapshot){
    ...
    return (
        ...
        <>
        <NavbarCliente/>
        <Typography style={{color: "#000000", fontHeight: 'bold'}} className={classes.tituloModal}>Estacionamientos abiertos todo el día: {estacionamientos.length}</Typography>
...
export default EstacionamientosHorarioCorrido;