...
const EstacionamientosMasValorados = () => {
   ...
   function manejarSnapshot(snapshot){
    ...
    return (
        ...
        <>
        <NavbarCliente/>
        <Typography style={{color: "#000000", fontHeight: 'bold'}} className={classes.tituloModal}>Estacionamientos más valorados: {estacionamientos.length}</Typography>
...
export default EstacionamientosMasValorados;