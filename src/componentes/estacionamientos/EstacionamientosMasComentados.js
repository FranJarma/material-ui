...
const EstacionamientosMasComentados = () => {
   ...
   function manejarSnapshot(snapshot){
    ...
    return (
        ...
        <>
        <NavbarCliente/>
        <Typography style={{color: "#000000", fontHeight: 'bold'}} className={classes.tituloModal}>Estacionamientos más comentados: {estacionamientos.length}</Typography>
...
export default EstacionamientosMasComentados;